...
echo -e "      - A6:"
echo -e "            mvn -f /vagrant/exercises/A6/java_sample/pom.xml spring-boot:run"
echo -e "            curl --cacert /home/vagrant/localhost.crt https://localhost:16443/greetings?name=Dave"
echo -e "            curl --location --cacert /home/vagrant/localhost.crt http://localhost:16080/greetings?name=Dave"
echo -e "${ORANGE} * Exercises after A.6 (if there are some)"
